"""
Patched authenticator.py for openconnect-sso with external browser support.
"""
...
class Authenticator:
    ...
    async def authenticate(self, display_mode, external_browser=False):
        ...
        sso_token = await self._authenticate_in_browser(
            auth_request_response, display_mode, external_browser=external_browser
        )
    ...
    # PATCH: Add external_browser parameter
    async def _authenticate_in_browser(self, auth_request_response, display_mode, external_browser=False):
