#!/usr/bin/env python3
"""
Patched cli.py for openconnect-sso with external browser support.
"""
...
def create_argparser():
    ...
    # PATCH: Add external browser support
    parser.add_argument(
        "--external-browser",
        help="Use external system browser (Chrome/Chromium) for SSO authentication. "
